...
public interface Messages {
    ...
    String VARIABLE_IS_NOT_MUTTABLE = "Variable %s is not mutable";
    ...
    String CALL_ARGUMENTS_MISMATCH = "Arguments does not match parameters for method call %s";
    ...
    String CLASS_DONT_EXIST = "Class for name = %s doesn't exist";
